...
private var declaredEncodables: Void = {
    ...
    declareEncodable(PartygramDeletedMessageAttribute.self, f: { PartygramDeletedMessageAttribute(decoder: $0) })
    declareEncodable(PartygramEditHistoryMessageAttribute.self, f: { PartygramEditHistoryMessageAttribute(decoder: $0) })
